...
from app.services.video_adapter import build_barobon_payload, build_video_summary, image_to_data_url
...
def test_video_summary_and_payload_analysis_contract(monkeypatch) -> None:
    ...
    media = {"peak_image_data_url": image_to_data_url(raw["worst"]["img"])}
